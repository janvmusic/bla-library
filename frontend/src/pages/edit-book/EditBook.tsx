...
import type { BookFormFields } from './types';
import {
  PageLayout,
  TopBar,
  BodyLayout,
      ...
      <BodyLayout>
        ...
        <ContentWrapper>
          ...
          <MainContent>
            ...
            <FormCard>
              <StyledForm onSubmit={handleSubmit} aria-label="Edit book form">
                <FieldGroup>
                ...
                <FormActions>
                  <SaveButton type="submit" disabled={isLoading} aria-label="Save changes">
